              ...
              <article key={product.id} className="glass-card metal-border grid gap-5 p-4 sm:grid-cols-[130px_1fr_auto] sm:items-center">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex items-center gap-2 text-sm text-muted transition hover:text-orange"
                  >
                    <Trash2 size={15} />
                    {t("actions.remove")}
                  </button>
                ...
                <div className="flex items-center gap-2 rounded-full border border-gray-200 bg-light-gray p-1">
                  <button
                    type="button"
                    className="grid h-9 w-9 place-items-center rounded-full text-muted transition hover:bg-orange/10 hover:text-foreground"
        ...
        <aside className="glass-panel metal-border h-fit p-6 lg:sticky lg:top-28">
          ...
          <div className="mt-5 grid gap-4 text-sm">
            ...
            <div className="flex justify-between border-b border-gray-200 pb-4 text-muted">
              ...
              <span className="text-deep-orange">{t("cart.manualQuote")}</span>
            </div>
            <div className="rounded-lg border border-orange/30 bg-orange/10 p-4 text-sm leading-6 text-deep-orange">
              {t("cart.priceNote")}
            </div>
          </div>
          <div className="mt-6 grid gap-3">
            <LocalizedLink href="/checkout" className="btn-primary">
